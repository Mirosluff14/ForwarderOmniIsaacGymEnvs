...
class ForwarderPickTask(RLTask):
    ...
    def calculate_metrics(self) -> None:
        ...
        wood_2_target_dist_z = torch.abs(self.target_pos[:,2]-self.wood_pos[:,2]).flatten()
        close_2_unload = torch.where(h_dist_wood_2_unloading < 1, 1, 0)
        wood_2_target_reward = (1 / (1. + wood_2_target_dist_z ** 2)) * self.wood_lifted * close_2_unload
